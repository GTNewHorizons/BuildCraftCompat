...
public class CompatModuleWAILA extends CompatModuleBase {
    ...
    @Override
    public void preInit() {
        ENABLE_BUILDER_DEBUG = BuildCraftCompat.instance.getConfig().getBoolean(
                "showBuilderSupportDebug",
                "waila",
                false,
                "Should WAILA tooltips show whether a block is supported by Builders or not?");
    }
