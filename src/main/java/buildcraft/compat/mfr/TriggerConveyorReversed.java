...
public class TriggerConveyorReversed extends BCStatement implements ITriggerExternal {
    ...
    @Override
    public boolean isTriggerActive(TileEntity tileEntity, ForgeDirection forgeDirection,
            IStatementContainer iStatementContainer, IStatementParameter[] iStatementParameters) {
