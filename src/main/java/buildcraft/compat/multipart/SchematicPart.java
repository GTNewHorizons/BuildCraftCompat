...
public abstract class SchematicPart<T extends TMultiPart> {
    ...
    /**
     * Get all the itemstacks required to place this part. If the part is not valid or cannot be placed, return null. It
     * is important that this method returns null if writePart does.
     * 
    ...
    /**
     * Convert this part to an NBT tag to be used with placePart. If this part is not valid or cannot be placed return
     * null It is important that this method returns null if getRequirements does.
     * 
     * @param part The multipart instance to be copied
    ...
    /**
     * Place the part represented by tag into the world. This method should call TileMultipart.canPlacePart and return
     * without placement if the part cannot be placed It is not necessary to apply rotations, but failing to do so may
     * prevent this part, or others in the same block space from being placed.
     * 
