...
public class CompatModuleRailcraft extends CompatModuleBase {
    ...
    private void initBuilders() {
        ...
        CompatUtils.registerSchematic(
                "Railcraft:anvil",
                SchematicRotateMeta.class,
                new Object[] { new int[] { 0, 1, 2, 3 }, Boolean.valueOf(true) });
        ...
        CompatUtils.registerSchematic(
                ...
                6,
                SchematicRCDirectional.class,
                new String[] { "direction", "profession" },
                true); // Trade Station
