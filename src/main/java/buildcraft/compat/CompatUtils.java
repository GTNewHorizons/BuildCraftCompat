...
public class CompatUtils {
    ...
    public static void registerSchematic(String blockName, int meta, Class<? extends Schematic> schematic,
            Object... params) {
        Block b = Block.getBlockFromName(blockName);
        if (b != null && b != Blocks.air) {
    ...
    public static void registerSchematic(String blockName, int minMeta, int maxMeta,
            Class<? extends Schematic> schematic, Object... params) {
        Block b = Block.getBlockFromName(blockName);
        if (b != null && b != Blocks.air) {
